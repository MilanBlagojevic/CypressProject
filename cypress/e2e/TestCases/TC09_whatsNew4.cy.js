...
describe("What's new functionality", () => {
  ...
  it("What's new page", () => {
    ...
    cy.xpath("//*[@id='maincontent']/div[4]/div[1]/div[2]/div[3]/div/div/ol/li[4]/div/div/strong/a").click();
    cy.get(".base").should("contain", "Zoltan Gym Tee");
    cy.get("#product-price-542 > .price").should("contain", "$29.00");
